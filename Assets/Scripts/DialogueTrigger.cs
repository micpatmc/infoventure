...
public class DialogueTrigger : MonoBehaviour
{
    // ---------------------------------------------------------------------
    // Summary:
    // Triggers dialogue bubbles when in radius of NPC's
    //
    // By: Michael Mcgarvey
    // ---------------------------------------------------------------------
    ...
    // Starts the beginning game conversation
    ...
    // Talks to NPC's depending on certain in-game requirements
    private void Update()
    {
        if (!FindObjectOfType<DialogueManager>().inDialogue)
        {
            ...
            // Talks to NPC #3 after books are finished
    ...
    {
        // Talks to NPC #3 before books are finished
    ...
    // Checks if the player is in radius
